package com.craft.apps.countdowns.feature.wear.tiles
...
@AndroidEntryPoint
class CountdownsTileService @Inject constructor(): SuspendingTileService() {
...
private fun tileLayout(context: Context): LayoutElementBuilders.LayoutElement {
    return PrimaryLayout.Builder(buildDeviceParameters(context.resources))
        .setContent(
            Text.Builder(context, "161 days until your birthday!")
                .setColor(argb(Colors.DEFAULT.onSurface))
//                .setTypography(AppTypographyStyles.labelMedium)
                .build()
        ).build()
}
