...
@Composable
internal fun ActiveCountdownsList(
    ...
    Column(
        ...
        Row(
            ...
            IconLabel(
                ...
                contentDescription = stringResource(R.string.content_description_active_countdowns),
                label = stringResource(R.string.list_label_active_countdowns),
            )
        }
        CountdownList(
...
@Composable
private fun ActiveCountdownsListPreview() {
